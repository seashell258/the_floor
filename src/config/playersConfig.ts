...
export const playersConfig: PlayerConfig[] = [
    {
        ...
        themes: [
            ...
            { name: '食物',                 photos: generatePhotoPaths('李怡臻', '食物',                 30), answers: ['墨西哥 taco','duck confit 油封鴨','可樂餅','千層麵','威靈頓牛排','千層酥','牛舌','避風塘炒蟹','戰斧牛排','火山排骨','芋頭飯  / 芋仔籤','大阪燒','土耳其烤肉 或 沙威馬','班尼迪克蛋','千層蛋糕','北京烤鴨','千層麵','烤乳豬','德國豬腳','烤火雞','炸魚薯條','閃電泡芙','吉拿棒','章魚燒','墨西哥玉米片','法國麵包','鳳梨酥','糖葫蘆串','粽子','關東煮'],          isConsumed: false, isActivated: true }
        ]
    },
    {
        name: '逸弘',
        themes: [
            ...
            { name: '臺灣老歌歌手', photos: generatePhotoPaths('逸弘', '臺灣老歌歌手', 34), answers: ['陳淑樺','洪榮宏','潘越雲','黃乙玲','羅大佑','文夏','齊秦','蔡琴','陳雷','鳳飛飛','動力火車','張雨生','林志炫','齊豫','黃鶯鶯','周華健','葉啟田','秀蘭瑪雅','蘇芮','江蕙','施文彬','費玉清','林慧萍','陳小雲','王傑','鍾興民','林生祥','黃連煜','鄧麗君','江淑娜','洪愛莉','蔡秋鳳','張清芳','方瑞娥'],          isConsumed: false, isActivated: true }
        ]
    },
    {
        name: '李長鴻',
        themes: [
            { name: '單機遊戲', photos: generatePhotoPaths('李長鴻', '單機遊戲', 30), answers: ['答案1', '答案2'], isConsumed: false, isActivated: true },
            { name: '哲學家語錄', photos: generatePhotoPaths('李長鴻', '哲學家語錄', 30), answers: ['答案3'],          isConsumed: false, isActivated: true },
            { name: '美國卡通', photos: generatePhotoPaths('李長鴻', '美國卡通', 30), answers: ['答案4'],          isConsumed: false, isActivated: true },
            { name: '希臘神話人物', photos: generatePhotoPaths('李長鴻', '希臘神話人物', 30), answers: ['答案5'],          isConsumed: false, isActivated: true }
        ]
    },
    {
        name: '戴笠',
        themes: [
            ...
            { name: '文化節慶', photos: generatePhotoPaths('戴笠', '文化節慶', 30), answers: ['農曆新年','泰國潑水節','平溪天燈節','日本盂蘭盆節','日本花見','端午節','墨西哥亡靈節','泰國水燈節','里約嘉年華','西班牙番茄節','印度侯麗／灑紅節','札幌雪祭','（大甲）媽祖遶境','葡萄牙藝術節','韓國燃燈會','青森睡魔祭','西班牙奔牛節','英國Bonfire Night','蒙馬特葡萄收穫節','泰國萬佛節','巴西新年','夏威夷花環節','拉丁美洲聖週','仲夏節','歐洲五朔節','基督教聖體聖血節','西藏跳神節','西班牙法雅節','巴布亞紐幾內亞面具節','美國火人祭'],          isConsumed: false, isActivated: true }
        ]
    },
    {
        name: 'VJ',
        themes: [
            ...
            { name: '西方奇幻小說', photos: generatePhotoPaths('VJ', '西方奇幻小說', 28), answers: ['哈利波特','波西傑克森','法柏哈溫','魔戒','納尼亞傳奇','迷霧之子','颶光典籍','時光之輪','黑塔','弒君者三部曲','冰與火之歌','獵魔士','黑暗元素三部曲','遺產四部曲','皇家騎士','阿提米斯（阿特米斯奇幻歷險）','埃及守護神','天使聖物：骸骨之城','巫師神探','地海傳說','刺客後傳','碟型世界','第一法則','破碎大地','罌粟戰爭','太陽召喚','盜賊紳士拉莫瑞','不死煉金術師'],          isConsumed: false, isActivated: true }
        ]
    },
    {
        name: 'Josh 游沛駿',
    ...
    "Olivia Rodrigo　奧莉薇亞·羅德里戈"
            ...
            { name: '臺灣店家logo', photos: generatePhotoPaths('Josh 游沛駿', '臺灣店家logo', 37), answers: ['全聯','家樂福','7-11','全家','誠品','太平洋SOGO','黑松','味全','義美','光泉','迷客夏','COCO','清心福全','八方雲集','純喫茶','大潤發','康是美','寶雅','小林眼鏡','燦坤','全國電子','特力屋','愛買','World Gym','健身工廠','摩斯漢堡','頂呱呱','爭鮮','石二鍋','麥味登','路易莎','Cama咖啡','伯朗咖啡','再睡五分鐘','Comebuy','21世紀風味烤雞','美廉社'],          isConsumed: false, isActivated: true }
        ]
    },
    {
        name: '貓南北',
        themes: [
            { name: '台灣常見外來種', photos: generatePhotoPaths('貓南北', '台灣常見外來種', 38), answers: ['小印度貓鼬','荒地麻蜥（外來族群）','埃及聖䴉','白腰文鳥（引入族群）','琵琶鼠魚','吳郭魚','紅火蟻','小火蟻','小花蔓澤蘭','銀合歡','綠鬣蜥','紅耳龜','斑文鳥（引入族群）','白頰椋鳥','美洲牛蛙','大肚魚','白尾捲葉象鼻蟲（擴散種）','椰子犀角金龜','大花咸豐草','互花米草','緬甸蟒','球蟒（逸出個體）','家八哥','爪哇八哥','孔雀魚（野化族群）','錦鯉（逸出族群）','布袋蓮','蘆葦（擴張族群）','食蟹獴（待替換）','家兔（野化族群）','鸚鵡（多種逸出）','珠頸斑鳩（部分外來族群）','鱷龜','彩龜','番石榴果實蠅','貓跳蚤','馬纓丹','美洲含羞草'], isConsumed: false, isActivated: true },
            { name: '台灣原生動植物物種', photos: generatePhotoPaths('貓南北', '台灣原生動植物物種', 38), answers: ['臺灣黑熊','臺灣獼猴','臺灣油杉','臺灣扁柏','石虎','臺灣穿山甲','紅檜','臺灣杉','梅花鹿','臺灣水鹿','昆欄樹','臺灣山毛櫸','臺灣藍鵲','帝雉','臺灣二葉松','臺灣五葉松','藍腹鷴','臺灣山鷓鴣','玉山圓柏','臺灣魚鱗雲杉','臺灣長鬃山羊','臺灣野豬','臺灣百合','臺灣一葉蘭','臺灣飛鼠','臺灣草蜥','臺灣蝴蝶蘭','臺灣金線蓮','雲豹','臺灣爬岩鰍','玉山薄雪草','臺灣高山杜鵑','臺灣朱雀','臺灣陸龜','臺灣馬醉木','臺灣澤蘭','臺灣胡桃','臺灣野薔薇'],          isConsumed: false, isActivated: true },
            { name: '台灣行道樹&園藝植物', photos: generatePhotoPaths('貓南北', '台灣行道樹&園藝植物', 36), answers: ['榕樹','虎尾蘭','茄苳','唐竹','阿勃勒','班葉鵝掌藤','臺灣欒樹','黑松','雪茄花','樟樹','琴葉榕','重陽木','蒲葵','苦楝','天堂鳥','九芎','日本女貞','臺灣櫸（雞油）','龜背芋','白千層','厚葉石斑木','山櫻花（緋寒櫻）','百合竹','楓香','五爪木','水黃皮','蘭嶼肉桂','光臘樹','臺北海桐','黃槿','印度橡膠樹','青楓','竹柏','朴樹','白水木','瓊崖海棠'],          isConsumed: false, isActivated: true },
            { name: '蔬菜水果', photos: generatePhotoPaths('貓南北', '蔬菜水果', 40), answers: ['蘋果','香蕉','西瓜','芒果','鳳梨','木瓜','蓮霧','芭樂','葡萄','草莓','荔枝','龍眼','楊桃','釋迦','百香果','火龍果','柳橙','柚子','檸檬','番茄','高麗菜','花椰菜','空心菜','地瓜葉','菠菜','茄子','苦瓜','絲瓜','冬瓜','南瓜','小黃瓜','玉米','紅蘿蔔','白蘿蔔','馬鈴薯','地瓜','芋頭','蘆筍','韭菜','山藥'],          isConsumed: false, isActivated: true }
        ]
    },
    {
        name: '何柏穎',
        themes: [
            ...
            { name: '體育/運動項目', photos: generatePhotoPaths('何柏穎', '體育/運動項目', 48), answers: ['足球','籃球','棒球','網球','排球','桌球','羽毛球','游泳','跳水','衝浪','滑板','滑雪','單板滑雪','溜冰（花式／競速）','體操（地板）','韻律體操','跨欄','標槍','鉛球','跳高','撐竿跳','舉重','摔角','柔道','拳擊','劍道','擊劍','射箭','射擊','馬術','賽車（F1）','自行車（公路賽）','越野滑輪','划船','帆船','衝浪風帆','攀岩','跳傘'],          isConsumed: false, isActivated: true }
        ]
    }
]
