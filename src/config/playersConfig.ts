...
{ name: '食材',                 photos: generatePhotoPaths('主持人', '食材',                 30), answers: ["茭白筍","龍鬚菜","山蘇","過貓（蕨菜）","大白菜","青江菜","香菇","金針菇","豬五花","雞腿肉","豬絞肉","牛腩","豬梅花肉","雞翅","虱目魚","透抽","蛤蜊","牡蠣","白蝦","花枝","板豆腐","豆干","油豆腐","嫩豆腐","米粉","地瓜","芋頭","冬粉","九層塔","薑"], isActivated: true },
{ name: '廚具',                 photos: generatePhotoPaths('主持人', '廚具',                 30), answers: ["主廚刀","麵包刀","削皮刀","砧板","剪刀","炒鍋","湯鍋","平底鍋","蒸鍋","壓力鍋","烤盤","鑄鐵鍋","量杯","量匙","料理秤","溫度計","電動打蛋器","橡皮刮刀","木匙","夾子","漏杓","篩網／濾網","研磨缽","電鍋","果汁機／調理機","微波爐","氣炸鍋","烤箱","擀麵棍","開罐器"], isActivated: true },
